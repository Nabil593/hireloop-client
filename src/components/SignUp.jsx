                    ...
                    <form className="space-y-4">
                        ...
                        <div className="pt-1">
                            <label className="flex items-start gap-2.5 cursor-pointer group">
                                <input
                                    type="checkbox"
                                    className="mt-0.5 w-3.5 h-3.5 rounded bg-[#121212] border-neutral-800 text-indigo-600 focus:ring-0 focus:ring-offset-0 checked:bg-indigo-500 transition-all"
                                    required
                                />
                                <span className="text-xs text-neutral-500 group-hover:text-neutral-400 transition-colors leading-normal">
                                    I agree to the{' '}
                                    <a href="#terms" className="text-neutral-400 hover:text-indigo-400 underline decoration-neutral-700 underline-offset-2">
                                        Terms of Service
                                    </a>{' '}
                                    and{' '}
                                    <a href="#privacy" className="text-neutral-400 hover:text-indigo-400 underline decoration-neutral-700 underline-offset-2">
                                        Privacy Policy
                                    </a>.
                                </span>
                            </label>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-indigo-600 hover:bg-indigo-500 text-xs font-semibold text-white h-11 rounded-lg transition-all duration-200 shadow-lg shadow-indigo-600/10 mt-2 active:scale-[0.99]"
                        >
                            Get Started
                        </button>
                    </form>
